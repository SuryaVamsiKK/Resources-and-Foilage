...
namespace UnityEngine.PostProcessing
{
    ...
    public class BuiltinDebugViewsModel : PostProcessingModel
    {
        ...
        public struct MotionVectorsSettings
        {
            ...
            [MinsAttribute(0f), Tooltip("Because motion vectors are mainly very small vectors, you can use this setting to make them more visible.")]
            ...
            [MinsAttribute(0f), Tooltip("Tweaks the arrows length.")]
