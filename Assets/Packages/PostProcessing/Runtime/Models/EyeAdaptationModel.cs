...
namespace UnityEngine.PostProcessing
{
    ...
    public class EyeAdaptationModel : PostProcessingModel
    {
        ...
        public struct Settings
        {
            ...
            [MinsAttribute(0f), Tooltip("Exposure bias. Use this to offset the global exposure of the scene.")]
            ...
            [MinsAttribute(0f), Tooltip("Adaptation speed from a dark to a light environment.")]
            public float speedUp;

            [MinsAttribute(0f), Tooltip("Adaptation speed from a light to a dark environment.")]
