...
namespace UnityEngine.PostProcessing
{
    ...
    public class BloomModel : PostProcessingModel
    {
        ...
        {
            [MinsAttribute(0f), Tooltip("Strength of the bloom filter.")]
            public float intensity;

            [MinsAttribute(0f), Tooltip("Filters out pixels under this level of brightness.")]
        ...
        public struct LensDirtSettings
        {
            ...
            [MinsAttribute(0f), Tooltip("Amount of lens dirtiness.")]
            public float intensity;
